...
<body>
    ...
    <div class="main-content">
        ...
        ?>
        <!-- Header --><!-- For more projects: Visit dnxempire.com  -->
            ...
            <div class="row">
                <div class="col">
                    <div class="card shadow">
                        <div class="card-header border-0"><!-- For more projects: Visit dnxempire.com  -->
                            Food Items
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody><!-- For more projects: Visit dnxempire.com  -->
                                    <?php
