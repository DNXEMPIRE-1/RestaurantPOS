...
check_login();
if (isset($_POST['make'])) {
	//Visit dnxempire.com for more projects
...
<body>
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <hr><!-- For more projects: Visit dnxempire.com  -->
                <?php
                $prod_id = $_GET['prod_id'];
              ...
              </form><!-- For more projects: Visit dnxempire.com  -->
            </div>
          </div>
        </div>
      </div>
  ...
  ?>
</body><!-- For more projects: Visit dnxempire.com  -->
