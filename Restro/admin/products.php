...
<body>
  <!-- Sidenav --><!-- For more projects: Visit dnxempire.com  -->
  <?php
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <a href="add_product.php" class="btn btn-outline-success">
                ...
                Add New Product
              </a><!-- For more projects: Visit dnxempire.com  -->
            </div>
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                </thead><!-- For more projects: Visit dnxempire.com  -->
                <tbody>
                  <?php
                  ...
                  ?>
                    ...
                    </tr><!-- For more projects: Visit dnxempire.com  -->
                  <?php } ?>
                </tbody>
              </table>
            </div>
